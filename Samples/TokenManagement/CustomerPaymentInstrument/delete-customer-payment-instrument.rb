...
require_relative './create-customer-non-default-payment-instrument-card.rb'
...
class Delete_customer_payment_instrument
    def run()
        ...
        payment_instrument_token_id = (JSON.parse(Create_customer_non_default_payment_instrument_card.new.run()))['id']
