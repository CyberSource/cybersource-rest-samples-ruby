...
class Create_customer_payment_instrument_bank_account
    def run()
        ...
        bank_account = CyberSource::DefaultPaymentInstrumentBankAccount.new
        bank_account.type = "savings"
        request_obj.bank_account = bank_account

        buyer_information = CyberSource::DefaultPaymentInstrumentBuyerInformation.new
        buyer_information.company_tax_id = "12345"
        buyer_information.currency = "USD"
        buyer_information.date_of_birth = "2000-12-13"

        personal_identification = []
        personal_identification1 = CyberSource::DefaultPaymentInstrumentBuyerInformationPersonalIdentification.new
        personal_identification1.id = "57684432111321"
        personal_identification1.type = "driver license"
        issued_by1 = CyberSource::DefaultPaymentInstrumentBuyerInformationIssuedBy.new
        ...
        bill_to = CyberSource::DefaultPaymentInstrumentBillTo.new
        ...
        instrument_identifier = CyberSource::DefaultPaymentInstrumentInstrumentIdentifier.new
