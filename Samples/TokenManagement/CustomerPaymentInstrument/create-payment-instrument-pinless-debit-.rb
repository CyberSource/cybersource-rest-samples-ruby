...
public
class Create_payment_instrument_pinless_debit_
    def run()
        opts = {}
	...
	customer_token_id = "A822E6E50ED5C604E05341588E0A12EC"
        ...
        data, status_code, headers = api_instance.post_customer_payment_instrument(customer_token_id, request_obj, opts)
    ...
    if __FILE__ == $0
        Create_payment_instrument_pinless_debit_.new.run()
    end
end
