...
public
class Create_customer_default_payment_instrument_card
    def run()
        ...
        card = CyberSource::DefaultPaymentInstrumentCard.new
    ...
    if __FILE__ == $0
        Create_customer_default_payment_instrument_card.new.run()
    end
end
