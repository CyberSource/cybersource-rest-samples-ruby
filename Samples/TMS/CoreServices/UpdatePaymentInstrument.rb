...
class UpdatePaymentInstrument
  def main
    ...
    response = RetrievePaymentInstrument.new.main
    ...
    response_body, response_code, response_headers = api_instance.tms_v1_paymentinstruments_token_id_patch(profile_id, id, request)
    puts "\nAPI REQUEST HEADERS:"
  ...
  if __FILE__ == $0
    UpdatePaymentInstrument.new.main
  end
end
