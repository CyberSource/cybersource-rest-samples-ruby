...
public
class Create_alternative_payments_notification_webhook
    def run()
        ...
        request_obj.product_id = "alternativePaymentMethods"

        event_types =  []
        event_types << "payments.payments.updated"
    ...
    if __FILE__ == $0
        Create_alternative_payments_notification_webhook.new.run()
    end
end