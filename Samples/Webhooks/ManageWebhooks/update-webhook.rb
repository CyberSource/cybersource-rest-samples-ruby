...
class Update_webhook
    def run(webhook_id)
        ...
        data, status_code, headers = api_instance.update_webhook_subscription(webhook_id, request_obj, opts)
