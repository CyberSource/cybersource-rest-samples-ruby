...
public
class Authorization_with_instrument_identifier_token_creation
    def run()
        ...
        action_token_types =  []
        action_token_types << "instrumentIdentifier"
    ...
    if __FILE__ == $0
        ...
        Authorization_with_instrument_identifier_token_creation.new.run()
    end
end
