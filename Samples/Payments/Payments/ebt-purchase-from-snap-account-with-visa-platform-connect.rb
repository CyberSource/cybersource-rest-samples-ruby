...
public
class Ebt_purchase_from_snap_account_with_visa_platform_connect
    def run()
        request_obj = CyberSource::CreatePaymentRequest.new
        client_reference_information = CyberSource::Ptsv2paymentsClientReferenceInformation.new
        client_reference_information.code = "EBT - Purchase From SNAP Account"
        ...
        amount_details.total_amount = "101.00"
    ...
    if __FILE__ == $0
        Ebt_purchase_from_snap_account_with_visa_platform_connect.new.run()
    end
end