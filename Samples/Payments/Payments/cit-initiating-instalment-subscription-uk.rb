...
public
class Cit_initiating_instalment_subscription_uk
    def run()
        ...
        recurring_options = CyberSource::Ptsv2paymentsProcessingInformationRecurringOptions.new
        recurring_options.loan_payment = false
        recurring_options.first_recurring_payment = true
        processing_information.recurring_options = recurring_options
        ...
        consumer_authentication_information.cavv = "EHuWW9PiBkWvqE5juRwDzAUFBAk="
    ...
    if __FILE__ == $0
        Cit_initiating_instalment_subscription_uk.new.run()
    end
end