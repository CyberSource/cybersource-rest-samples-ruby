...
public
class Mit_industry_practice_resubmission
    def run()
        ...
        processing_information.commerce_indicator = "moto"
        ...
        merchant_initiated_transaction.reason = "1"
    ...
    if __FILE__ == $0
        Mit_industry_practice_resubmission.new.run()
    end
end