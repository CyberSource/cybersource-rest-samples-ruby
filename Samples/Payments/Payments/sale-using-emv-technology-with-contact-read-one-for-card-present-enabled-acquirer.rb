...
public
class Sale_using_emv_technology_with_contact_read_one_for_card_present_enabled_acquirer
    def run()
    ...
    if __FILE__ == $0
        ...
        Sale_using_emv_technology_with_contact_read_one_for_card_present_enabled_acquirer.new.run()
    end
end
