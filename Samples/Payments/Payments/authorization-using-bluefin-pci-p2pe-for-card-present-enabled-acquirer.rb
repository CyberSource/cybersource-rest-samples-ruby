...
public
class Authorization_using_bluefin_pci_p2pe_for_card_present_enabled_acquirer
    def run()
    ...
    if __FILE__ == $0
        ...
        Authorization_using_bluefin_pci_p2pe_for_card_present_enabled_acquirer.new.run()
    end
end
