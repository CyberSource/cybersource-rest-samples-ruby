...
public
class Mit_industry_practice_delayed_charge_3ri_visa
    def run()
        ...
        merchant_initiated_transaction.reason = "2"
        ...
        consumer_authentication_information.pares_status = "Y"
    ...
    if __FILE__ == $0
        Mit_industry_practice_delayed_charge_3ri_visa.new.run()
    end
end