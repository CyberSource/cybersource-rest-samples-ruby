...
public
class Sale_using_emv_technology_with_contactless_read_for_card_present_with_ctv
    def run()
    ...
    if __FILE__ == $0
        ...
        Sale_using_emv_technology_with_contactless_read_for_card_present_with_ctv.new.run()
    end
end
