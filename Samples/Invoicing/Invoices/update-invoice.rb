...
class Update_invoice
  def run()
    ...
    customer_information.email = "new_email@my-email.world"
    request_obj.customer_information = customer_information

    invoice_information = CyberSource::Invoicingv2invoicesidInvoiceInformation.new
    invoice_information.description = "This is after updating invoice"
