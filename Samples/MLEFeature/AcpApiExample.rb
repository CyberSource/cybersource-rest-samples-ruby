...
class Acp_api_example
    def run()
        ...
        device_information = CyberSource::Iccv1tokensDeviceInformation.new
        ...
        device_data = CyberSource::Iccv1tokensDeviceInformationDeviceData.new
        ...
        buyer_information = CyberSource::Iccv1tokensBuyerInformation.new
        buyer_information.language = "en"
        buyer_information.merchant_customer_id = "3e1b7943-6567-4965-a32b-5aa93d057d35"

        personal_identification = []
        personal_identification1 = CyberSource::Iccv1tokensBuyerInformationPersonalIdentification.new
        ...
        bill_to = CyberSource::Iccv1tokensBillTo.new
        ...
        consumer_identity = CyberSource::Iccv1tokensConsumerIdentity.new
        ...
        payment_information = CyberSource::Iccv1tokensPaymentInformation.new
        customer = CyberSource::Iccv1tokensPaymentInformationCustomer.new
        customer.id = ""
        payment_information.customer = customer
        payment_instrument = CyberSource::Iccv1tokensPaymentInformationPaymentInstrument.new
        payment_instrument.id = ""
        payment_information.payment_instrument = payment_instrument
        instrument_identifier = CyberSource::Iccv1tokensPaymentInformationInstrumentIdentifier.new
        ...
        enrollment_reference_data = CyberSource::Iccv1tokensEnrollmentReferenceData.new
        ...
        assurance_data = []
        assurance_data1 = CyberSource::Iccv1tokensAssuranceData.new
        ...
        authentication_context1 = CyberSource::Iccv1tokensAuthenticationContext.new
        authentication_context1.action = "AUTHENTICATE"
        assurance_data1.authentication_context = authentication_context1
        authenticated_identities1 = CyberSource::Iccv1tokensAuthenticatedIdentities.new
        ...
        consent_data = []
        consent_data1 = CyberSource::Iccv1tokensConsentData.new
