...
public
class PaymentsWithMLEControlFromMapConfig
  def run(flag)
    ...
    config = MerchantConfiguration.merchantConfigPropWithMLEMAPAndGlobalFlagDisabled
  ...
  if __FILE__ == $0
    PaymentsWithMLEControlFromMapConfig.new.run(false)
  end
end
