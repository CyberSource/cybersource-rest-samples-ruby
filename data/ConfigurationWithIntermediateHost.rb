...
class MerchantConfiguration
  def merchantConfigProp()
    ...
    intermediateHost='http://localhost:8080'
    ...
    configurationDictionary['intermediateHost'] = intermediateHost
    ...
    custom_headers['Ocp-Apim-Subscription-Key'] = 'Test555555'

    configurationDictionary['defaultCustomHeaders'] = custom_headers
